...
// Decorator Design Pattern: a structural pattern that allows you to add new responsibilities
// or behaviors to an object dynamically at runtime, without altering its original structure
